...
export const SEO = {
  '/': {
    title: 'Institutional Clean Cooking Across Africa | IGNIS',
    description:
      'IGNIS designs, finances and runs institutional clean cooking systems for schools, hospitals and prisons across Africa, paid from your existing fuel budget.',
  },
  '/solutions': {
  ...
  '/who-we-serve/delivery-partners': {
